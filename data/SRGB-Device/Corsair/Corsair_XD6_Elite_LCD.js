...
export function Name() { return "Corsair XD6 Elite LCD"; }
export function VendorId() { return 0x1b1c; }
export function ProductId() { return 0x0C43; }
...
function sendZone(packetRGBDataLength, RGBData, packetsSent, finalPacket) {
	...
	let packet = [0x02, 0x05, 0x01, finalPacket, packetsSent, 0x00, (packetRGBDataLength & 0xFF), (packetRGBDataLength >> 8 & 0xFF)];
...
export function ImageUrl() {
	return "https://assets.signalrgb.com/devices/brands/corsair/aio/link-lcd.png";
}